...
class EmailServiceGmail {
  constructor() {
    // Check if Gmail is configured
    this.isConfigured = process.env.SMTP_USER && 
    ...
    if (this.isConfigured) {
      ...
      console.log('⚠️ Gmail app password not configured, using development mode');
      console.log('🔧 To configure Gmail:');
      console.log('1. Enable 2-factor authentication on Gmail');
      console.log('2. Generate app password from Google Account settings');
      console.log('3. Update SMTP_PASS in .env file with the app password');
  ...
  async sendVerificationEmail(user, token) {
    ...
    if (!this.isConfigured) {
      ...
      console.log('💡 Configure Gmail to send real emails\n');
      return true;
    }
  ...
  async sendWelcomeEmail(user) {
    if (!this.isConfigured) {
      ...
      console.log('📧 Email:', user.email);
      console.log('👤 Username:', user.username);
      console.log('🎉 Welcome to Clocked!');
      console.log('💡 Configure Gmail to send real emails\n');
      return true;
    }
...
module.exports = new EmailServiceGmail();
